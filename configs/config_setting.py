...
class setting_config:
    ...
    model_config = {
        ...
        'depths': [3,3,3,3],
        'depths_decoder': [3,3,3,3],
        'drop_path_rate': 0.2,
        'load_ckpt_path': '/home/sql/VM-UNet-main/pre_trained_weights/vmamba_small_e238_ema.pth',
    }

    datasets = 'skin' 
    if datasets == 'skin':
        data_path = '/home/sql/VM-UNet-main/data/'
    else:
    ...
    work_dir = '/home/sql/results/' + network + '_' + datasets + '_' + datetime.now().strftime('%A_%d_%B_%Y_%Hh_%Mm_%Ss') + '/'
    # work_dir = '/home/sql/results/newnewMLP0.55/'
    # work_dir = '/home/sql/results/org51.9/'
    # work_dir = '/home/sql/results/vmunet_skinp8_Friday_26_July_2024_10h_46m_14s/'
    ...
    train_transformer = transforms.Compose([
        ...
        # myColorJitter(brightness=0.5, contrast=0.3, saturation=0.3, hue=0.1)
    ])
